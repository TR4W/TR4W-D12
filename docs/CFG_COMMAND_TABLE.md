...
### The contest set — 63 of the 179 rows still `csOld`
...
### 116 rows to migrate to the registry
...
**Until this is ruled on they are held back and the other 85 proceed.** Splitting the batch costs
