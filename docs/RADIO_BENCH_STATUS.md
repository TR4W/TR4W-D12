...
|---|---|---|---|---|
| Elecraft K2 | K2 | - | - |  |
| Elecraft K3 | K3 | 2026-07-31 | NY4I | CW-by-CAT send verified (KY padded to 22). Escape-stops-CW failed, fixed 163723a, RETESTED OK. |
| Elecraft K4 | K4 | 2026-07-30 | NY4I | Split: FT1; alone is sufficient (RX always VFO A). CW-by-CAT in use. |
| Elecraft KX3 | KX3 | - | - |  |
