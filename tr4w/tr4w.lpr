...
uContestFileKind in 'src\domain\uContestFileKind.pas',
  ...
  uEditingKeys in 'src\ui\lcl\uEditingKeys.pas',
  ...
  uWindowTable in 'src\ui\lcl\uWindowTable.pas',
  ...
  uKeychainWindows in 'src\uKeychainWindows.pas',
  uCrashLog in 'src\uCrashLog.pas',
  uCrashLogLCL in 'src\ui\lcl\uCrashLogLCL.pas',
  uPasswordReveal in 'src\ui\lcl\uPasswordReveal.pas',
  ...
  uSortedStringList in 'src\uSortedStringList.pas',
  ...
  uStickyKeys in 'src\uStickyKeys.pas',
  uStringCompare in 'src\utils\uStringCompare.pas',
  uAudio in 'src\utils\uAudio.pas',
  uFileText in 'src\utils\uFileText.pas',
  uHostName in 'src\utils\uHostName.pas',
  uPlatformFonts in 'src\utils\uPlatformFonts.pas',
...
uLogEditForm in 'src\ui\lcl\uLogEditForm.pas',
  ...
  uFirstRunConvert in 'src\ui\lcl\uFirstRunConvert.pas',
  uIniRetireForm in 'src\ui\lcl\uIniRetireForm.pas',
  uVerificationChecks in 'src\uVerificationChecks.pas',
  uVerificationForm in 'src\ui\lcl\uVerificationForm.pas',
  ...
  uMainThread in 'src\uMainThread.pas',
  uElementPanel in 'src\ui\lcl\uElementPanel.pas',
  uLogGrid in 'src\ui\lcl\uloggrid.pas',
  uLogSearchForm in 'src\ui\lcl\uLogSearchForm.pas',
  uMacMenuBar in 'src\ui\lcl\uMacMenuBar.pas',
  uMainForm in 'src\ui\lcl\uMainForm.pas',
  uSystemWatch in 'src\ui\lcl\uSystemWatch.pas',
  uAppTimers in 'src\ui\lcl\uAppTimers.pas',
  uMainGrids in 'src\ui\lcl\uMainGrids.pas',
  uPrefsForm in 'src\ui\lcl\uPrefsForm.pas',
  uJSON in 'src\utils\uJSON.pas',
  uSHA256 in 'src\utils\uSHA256.pas',
  uOpenSSLLoader in 'src\utils\uOpenSSLLoader.pas',
  ...
  uSerialDiagnosis in 'src\uSerialDiagnosis.pas',
  ...
  uSettingsEffects in 'src\uSettingsEffects.pas',
