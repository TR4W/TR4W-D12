...
unit uRadioKenwoodTS480;

{
  Kenwood TS-480 (serial CAT).  A thin per-model subclass of TKenwoodSerial --
  the TS-480 is a plain standard-Kenwood serial radio, so it only names itself
...
type
  TKenwoodTS480Radio = class(TKenwoodSerial)
  public
...
constructor TKenwoodTS480Radio.Create;
begin
  inherited Create;
  radioModel := 'Kenwood TS-480';
...
function CreateKenwoodTS480: TFactoryRadioBase;
begin
   Result := TKenwoodTS480Radio.Create;
end;
