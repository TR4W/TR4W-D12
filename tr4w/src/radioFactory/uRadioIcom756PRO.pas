...
unit uRadioIcom756PRO;

{
  Icom IC-756PRO -- CI-V address $5C.
...
type
  TIcom756PRORadio = class(TIcomReadLimitedRadio)
  public
...
constructor TIcom756PRORadio.Create;
begin
   inherited Create;
   RadioAddress := $5C;
   radioModel := 'Icom IC-756PRO';
end;
...
function CreateIcom756PRO: TFactoryRadioBase;
begin
   Result := TIcom756PRORadio.Create;
end;

initialization
  RegisterRadio(IC756PRO,
     CreateIcom756PRO,
     'Icom IC-756PRO', [rlSerial], 0, False,
