...
type
  TIcom781Radio = class(TIcomReadLimitedRadio)
  public
...
constructor TIcom781Radio.Create;
begin
   inherited Create;
   RadioAddress := $26;
   radioModel := 'Icom IC-781';
end;
...
function CreateIcom781: TFactoryRadioBase;
begin
   Result := TIcom781Radio.Create;
end;

initialization
  RegisterRadio(IC781,
     CreateIcom781,
     'Icom IC-781', [rlSerial], 0, False,
