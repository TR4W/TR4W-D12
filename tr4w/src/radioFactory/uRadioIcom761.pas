...
type
  TIcom761Radio = class(TIcomReadLimitedRadio)
  public
...
constructor TIcom761Radio.Create;
begin
   inherited Create;
   RadioAddress := $1E;
   radioModel := 'Icom IC-761';
end;
...
function CreateIcom761: TFactoryRadioBase;
begin
   Result := TIcom761Radio.Create;
end;
