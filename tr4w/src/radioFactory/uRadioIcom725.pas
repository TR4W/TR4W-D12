...
type
  TIcom725Radio = class(TIcomReadLimitedRadio)
  public
...
constructor TIcom725Radio.Create;
begin
   inherited Create;
   RadioAddress := $28;
   radioModel := 'Icom IC-725';
end;
...
function CreateIcom725: TFactoryRadioBase;
begin
   Result := TIcom725Radio.Create;
end;

initialization
  RegisterRadio(IC725,
     CreateIcom725,
     'Icom IC-725', [rlSerial], 0, False,
