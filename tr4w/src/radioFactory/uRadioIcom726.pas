...
type
  TIcom726Radio = class(TIcomReadLimitedRadio)
  public
...
constructor TIcom726Radio.Create;
begin
   inherited Create;
   RadioAddress := $30;
   radioModel := 'Icom IC-726';
end;
...
function CreateIcom726: TFactoryRadioBase;
begin
   Result := TIcom726Radio.Create;
end;

initialization
  RegisterRadio(IC726,
     CreateIcom726,
     'Icom IC-726', [rlSerial], 0, False,
