...
unit uRadioKenwoodTS590;
{$I ..\tr4w.inc}

{
  Kenwood TS-590 (serial CAT).  A thin per-model subclass of TKenwoodSerial --
  the TS-590 is a plain standard-Kenwood serial radio, so it only names itself
...
type
  TKenwoodTS590Radio = class(TKenwoodSerial)
  public
...
constructor TKenwoodTS590Radio.Create;
begin
  inherited Create;
  radioModel := 'Kenwood TS-590';
...
function CreateKenwoodTS590: TFactoryRadioBase;
begin
   Result := TKenwoodTS590Radio.Create;
end;
