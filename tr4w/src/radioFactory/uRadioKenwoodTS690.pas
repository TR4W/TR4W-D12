...
unit uRadioKenwoodTS690;

{
  Kenwood TS-690 (serial CAT).  A thin per-model subclass of TKenwoodSerial --
  the TS-690 is a plain standard-Kenwood serial radio, so it only names itself
...
type
  TKenwoodTS690Radio = class(TKenwoodSerial)
  public
...
constructor TKenwoodTS690Radio.Create;
begin
  inherited Create;
  radioModel := 'Kenwood TS-690';
end;
...
function CreateKenwoodTS690: TFactoryRadioBase;
begin
   Result := TKenwoodTS690Radio.Create;
end;

initialization
  RegisterRadio(TS690,
     CreateKenwoodTS690,
     'Kenwood TS-690', [rlSerial], 0, False,
