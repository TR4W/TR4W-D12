...
type
  TIcom707Radio = class(TIcomReadLimitedRadio)
  public
...
constructor TIcom707Radio.Create;
begin
   inherited Create;
   RadioAddress := $3E;
   radioModel := 'Icom IC-707';
end;
...
function CreateIcom707: TFactoryRadioBase;
begin
   Result := TIcom707Radio.Create;
end;
