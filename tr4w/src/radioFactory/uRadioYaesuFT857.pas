...

{
  ...
  Row: DIGU $0A, DIGL $FF -- DIG yes, PKT-as-RTTY no.  Split and RIT offset present.
...
type
  TYaesuFT857Radio = class(TYaesuFT817Group)
  public
...
function CreateYaesuFT857: TFactoryRadioBase;
begin
   Result := TYaesuFT857Radio.Create;
end;
