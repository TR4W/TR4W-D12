...
type
  TIcom756Radio = class(TIcomReadLimitedRadio)
  public
...
constructor TIcom756Radio.Create;
begin
   inherited Create;
   RadioAddress := $50;
   radioModel := 'Icom IC-756';
end;
...
function CreateIcom756: TFactoryRadioBase;
begin
   Result := TIcom756Radio.Create;
end;

initialization
  RegisterRadio(IC756,
     CreateIcom756,
     'Icom IC-756', [rlSerial], 0, False,
