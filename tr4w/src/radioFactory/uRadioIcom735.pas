...
type
  TIcom735Radio = class(TIcomReadLimitedRadio)
  public
...
constructor TIcom735Radio.Create;
begin
   inherited Create;
   RadioAddress := $04;
   radioModel := 'Icom IC-735';
end;
...
function CreateIcom735: TFactoryRadioBase;
begin
   Result := TIcom735Radio.Create;
end;

initialization
  RegisterRadio(IC735,
     CreateIcom735,
     'Icom IC-735', [rlSerial], 0, False,
