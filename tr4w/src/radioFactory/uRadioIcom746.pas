...
type
  TIcom746Radio = class(TIcomReadLimitedRadio)
  public
...
constructor TIcom746Radio.Create;
begin
   inherited Create;
   RadioAddress := $56;
   radioModel := 'Icom IC-746';
...
function CreateIcom746: TFactoryRadioBase;
begin
   Result := TIcom746Radio.Create;
end;

initialization
  RegisterRadio(IC746,
     CreateIcom746,
     'Icom IC-746', [rlSerial], 0, False,
