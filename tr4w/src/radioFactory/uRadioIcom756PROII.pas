...
type
  TIcom756PROIIRadio = class(TIcomReadLimitedRadio)
  public
...
constructor TIcom756PROIIRadio.Create;
begin
   inherited Create;
   RadioAddress := $64;
   radioModel := 'Icom IC-756PROII';
...
function CreateIcom756PROII: TFactoryRadioBase;
begin
   Result := TIcom756PROIIRadio.Create;
end;
