...
type
  TIcom775Radio = class(TIcomReadLimitedRadio)
  public
...
constructor TIcom775Radio.Create;
begin
   inherited Create;
   RadioAddress := $46;
   radioModel := 'Icom IC-775';
end;
...
function CreateIcom775: TFactoryRadioBase;
begin
   Result := TIcom775Radio.Create;
end;
