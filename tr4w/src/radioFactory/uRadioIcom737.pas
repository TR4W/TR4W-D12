...
type
  TIcom737Radio = class(TIcomReadLimitedRadio)
  public
...
constructor TIcom737Radio.Create;
begin
   inherited Create;
   RadioAddress := $3C;
   radioModel := 'Icom IC-737';
end;
...
function CreateIcom737: TFactoryRadioBase;
begin
   Result := TIcom737Radio.Create;
end;

initialization
  RegisterRadio(IC737,
     CreateIcom737,
     'Icom IC-737', [rlSerial], 0, False,
