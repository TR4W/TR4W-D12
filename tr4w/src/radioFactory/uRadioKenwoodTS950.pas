...
unit uRadioKenwoodTS950;
{$I ..\tr4w.inc}

{
  Kenwood TS-950 (serial CAT).  A thin per-model subclass of TKenwoodSerial --
  the TS-950 is a plain standard-Kenwood serial radio, so it only names itself
...
type
  TKenwoodTS950Radio = class(TKenwoodSerial)
  public
...
constructor TKenwoodTS950Radio.Create;
begin
  inherited Create;
  radioModel := 'Kenwood TS-950';
