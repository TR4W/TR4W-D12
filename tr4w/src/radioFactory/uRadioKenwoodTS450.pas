...
unit uRadioKenwoodTS450;
{$I ..\tr4w.inc}

{
  Kenwood TS-450 (serial CAT).  A thin per-model subclass of TKenwoodSerial --
  the TS-450 is a plain standard-Kenwood serial radio, so it only names itself
...
type
  TKenwoodTS450Radio = class(TKenwoodSerial)
  public
...
constructor TKenwoodTS450Radio.Create;
begin
  inherited Create;
  radioModel := 'Kenwood TS-450';
end;
...
function CreateKenwoodTS450: TFactoryRadioBase;
begin
   Result := TKenwoodTS450Radio.Create;
end;
