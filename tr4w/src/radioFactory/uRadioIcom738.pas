...
type
  TIcom738Radio = class(TIcomReadLimitedRadio)
  public
...
constructor TIcom738Radio.Create;
begin
   inherited Create;
   RadioAddress := $44;
   radioModel := 'Icom IC-738';
end;
...
function CreateIcom738: TFactoryRadioBase;
begin
   Result := TIcom738Radio.Create;
end;

initialization
  RegisterRadio(IC738,
     CreateIcom738,
     'Icom IC-738', [rlSerial], 0, False,
