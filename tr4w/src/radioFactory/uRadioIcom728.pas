...
type
  TIcom728Radio = class(TIcomReadLimitedRadio)
  public
...
constructor TIcom728Radio.Create;
begin
   inherited Create;
   RadioAddress := $38;
   radioModel := 'Icom IC-728';
end;
...
function CreateIcom728: TFactoryRadioBase;
begin
   Result := TIcom728Radio.Create;
end;

initialization
  RegisterRadio(IC728,
     CreateIcom728,
     'Icom IC-728', [rlSerial], 0, False,
