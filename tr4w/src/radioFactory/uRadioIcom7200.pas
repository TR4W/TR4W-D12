...
type
  TIcom7200Radio = class(TIcomReadLimitedRadio)
  public
...
constructor TIcom7200Radio.Create;
begin
   inherited Create;
   RadioAddress := $76;
   radioModel := 'Icom IC-7200';
...
function CreateIcom7200: TFactoryRadioBase;
begin
   Result := TIcom7200Radio.Create;
end;

initialization
  RegisterRadio(IC7200,
     CreateIcom7200,
     'Icom IC-7200', [rlSerial], 0, False,
