...
unit uRadioKenwoodTS2000;
{$I ..\tr4w.inc}

{
  Kenwood TS-2000 (serial CAT).  A thin per-model subclass of TKenwoodSerial --
  the TS-2000 is a plain standard-Kenwood serial radio, so it only names itself
...
type
  TKenwoodTS2000Radio = class(TKenwoodSerial)
  public
...
constructor TKenwoodTS2000Radio.Create;
begin
  inherited Create;
  radioModel := 'Kenwood TS-2000';
...
function CreateKenwoodTS2000: TFactoryRadioBase;
begin
   Result := TKenwoodTS2000Radio.Create;
end;
