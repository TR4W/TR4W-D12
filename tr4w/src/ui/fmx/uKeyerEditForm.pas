...
begin
   ...
   chkWKAutospace.IsChecked          := FKeyer.WKAutospace;
   chkWKCTSpacing.IsChecked          := FKeyer.WKCTSpacing;
   chkWKIgnoreSpeedPot.IsChecked     := FKeyer.WKIgnoreSpeedPot;
   chkWKSidetoneEnable.IsChecked     := FKeyer.WKSidetoneEnable;
   chkWKPaddleOnlySidetone.IsChecked := FKeyer.WKPaddleOnlySidetone;
   chkWKPaddleSwap.IsChecked         := FKeyer.WKPaddleSwap;
...
begin
   ...
   FKeyer.WKAutospace          := chkWKAutospace.IsChecked;
   FKeyer.WKCTSpacing          := chkWKCTSpacing.IsChecked;
   FKeyer.WKIgnoreSpeedPot     := chkWKIgnoreSpeedPot.IsChecked;
   FKeyer.WKSidetoneEnable     := chkWKSidetoneEnable.IsChecked;
   FKeyer.WKPaddleOnlySidetone := chkWKPaddleOnlySidetone.IsChecked;
   FKeyer.WKPaddleSwap         := chkWKPaddleSwap.IsChecked;
