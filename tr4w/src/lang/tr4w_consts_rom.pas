const
 ...
 TC_YOUCANCHANGETHISINYOURCONFIGFILE    = 'Asta se poate schimba numai prin fisierul de configurare.';
  ...
  TC_ALTRCOMMANDDISABLED                = 'Comanda Alt-R necesită TWO RADIO MODE = TRUE';
  ...
  TC_ALTDCOMMANDDISABLED                = 'Comanda Alt-D necesită TWO RADIO MODE = TRUE';
  ...
  TC_TOOLTIP_DISCOVERY                  = 'Descoperiţi radiouri în reţea';
