...
begin
  ...
  for CharPosition := 2 to 3 do
    if (Coordinates[CharPosition] = 'N') or (Coordinates[CharPosition] = 'S') then
       begin
       LatPos := CharPosition;
       end;
