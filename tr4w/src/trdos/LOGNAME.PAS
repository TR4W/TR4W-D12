...
begin
  ...
  if UnCommonCalls <> nil then
     begin
     Dispose(UncommonCalls);
     end;
  if UnCommonNames <> nil then
     begin
     Dispose(UncommonNames);
     end;
  if ClubCalls <> nil then
     begin
     Dispose(ClubCalls);
     end;
