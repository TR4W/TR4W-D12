...

{
  ...
  This unit is in no program's uses clause -- not tr4w.lpr, not the unit tests,
...
begin
  if NumberReminderRecords >= MaximumReminderRecords then
     ...
     QuickDisplay(TC_SORRYUSEDUPALLREMINDERS);
     //    Delay(2000);
