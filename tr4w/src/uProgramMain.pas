...
begin
  ...
  SetCharBuffer(TR4W_CTY_FILENAME, ctyPath);
...
{$ENDIF}
   ...
   SetCharBuffer(TR4W_PATH_NAME, DataDir);
...
{$ELSE}
  ...
  begin
    ...
    SetCharBuffer(TR4W_CFG_FILENAME, s);
    goto CommandLine;
  end;
...
{$ENDIF}
  ...
  LoadPOTAParksAsync(BackgroundEvents.PotaParksParsed);
