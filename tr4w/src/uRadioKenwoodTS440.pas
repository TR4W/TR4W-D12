...
{
  Kenwood TS-440 (serial CAT).  A thin per-model subclass of TKenwoodSerial --
  the TS-440 is a plain standard-Kenwood serial radio, so it only names itself
...
initialization
  RegisterRadio(TS440,
     function: TFactoryRadioBase begin Result := TKenwoodTS440Radio.Create end,
