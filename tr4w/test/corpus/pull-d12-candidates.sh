...
#
# The working directory is resolved by corpus_set_dir -- the staged copy under
# build-out/corpus-work that export-d12-corpus.sh just wrote.
...
echo "pulled $found D12 candidate(s) from $CORPUS_WORK"
echo
