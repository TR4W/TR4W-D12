...

{
  ...
  corpus_test_data/local_test_data/dxcluster (265 files, 198,979 "DX de" lines, AR-Cluster
...
const
   // ---- REAL lines, byte-for-byte from corpus_test_data/local_test_data/dxcluster ------
   //         0         1         2         3         4         5         6         7
